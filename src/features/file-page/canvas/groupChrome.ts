...
export const GROUP_CHROME = {
  frameClassName:
    'border-slate-300/90 bg-[rgba(245,248,252,0.98)] shadow-[0_28px_60px_-44px_rgba(15,23,42,0.3)] dark:border-slate-500/45 dark:bg-[rgba(30,41,59,0.84)] dark:shadow-[0_28px_60px_-44px_rgba(15,23,42,0.48)]',
  frameSelectedClassName: 'border-slate-900/25 ring-2 ring-slate-900/8 dark:border-slate-300/24 dark:ring-slate-200/12',
  frameResizingClassName: 'border-sky-300/85 ring-2 ring-sky-200/80',
  surfaceClassName:
    'pointer-events-none absolute inset-px rounded-[15px] bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(241,245,249,0.96))] shadow-[inset_0_1px_0_rgba(255,255,255,0.92),inset_0_0_0_1px_rgba(148,163,184,0.08)] dark:bg-[linear-gradient(180deg,rgba(43,56,80,0.92),rgba(27,37,55,0.96))] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06),inset_0_0_0_1px_rgba(100,116,139,0.26)]',
  ...
  guideIdleClassName: 'bg-slate-300/90 dark:bg-slate-500/70',
  guideActiveClassName: 'bg-sky-300/85',
  handleIdleClassName:
    'border-slate-300/90 bg-white/96 text-slate-600 shadow-[0_10px_24px_-18px_rgba(15,23,42,0.22)] dark:border-slate-500/45 dark:bg-slate-800/80 dark:text-slate-200 dark:shadow-[0_10px_24px_-18px_rgba(15,23,42,0.46)]',
